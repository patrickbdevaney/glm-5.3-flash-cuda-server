// unicode_cat.h — GENERATED by tools/gen_unicode_tables.py. Do not edit.
// unicodedata 15.0.0, python 3.12.3
// Sorted, disjoint [lo,hi] ranges per unicode general-category major class.
#pragma once
#include <cstdint>

static const uint32_t UC_L[][2] = {
...
{0x12000,0x12399},{0x12480,0x12543},{0x12F90,0x12FF0},{0x13000,0x1342F},{0x13441,0x13446},{0x14400,0x14646},{0x16800,0x16A38},{0x16A40,0x16A5E},
...
static const int UC_L_N = 659;

static const uint32_t UC_M[][2] = {
...
{0x10EAB,0x10EAC},{0x10EFD,0x10EFF},{0x10F46,0x10F50},{0x10F82,0x10F85},{0x11000,0x11002},{0x11038,0x11046},{0x11070,0x11070},{0x11073,0x11074},
{0x1107F,0x11082},{0x110B0,0x110BA},{0x110C2,0x110C2},{0x11100,0x11102},{0x11127,0x11134},{0x11145,0x11146},{0x11173,0x11173},{0x11180,0x11182},
{0x111B3,0x111C0},{0x111C9,0x111CC},{0x111CE,0x111CF},{0x1122C,0x11237},{0x1123E,0x1123E},{0x11241,0x11241},{0x112DF,0x112EA},{0x11300,0x11303},
{0x1133B,0x1133C},{0x1133E,0x11344},{0x11347,0x11348},{0x1134B,0x1134D},{0x11357,0x11357},{0x11362,0x11363},{0x11366,0x1136C},{0x11370,0x11374},
...
{0x11F3E,0x11F42},{0x13440,0x13440},{0x13447,0x13455},{0x16AF0,0x16AF4},{0x16B30,0x16B36},{0x16F4F,0x16F4F},{0x16F51,0x16F87},{0x16F8F,0x16F92},
{0x16FE4,0x16FE4},{0x16FF0,0x16FF1},{0x1BC9D,0x1BC9E},{0x1CF00,0x1CF2D},{0x1CF30,0x1CF46},{0x1D165,0x1D169},{0x1D16D,0x1D172},{0x1D17B,0x1D182},
...
{0x1DAA1,0x1DAAF},{0x1E000,0x1E006},{0x1E008,0x1E018},{0x1E01B,0x1E021},{0x1E023,0x1E024},{0x1E026,0x1E02A},{0x1E08F,0x1E08F},{0x1E130,0x1E136},
{0x1E2AE,0x1E2AE},{0x1E2EC,0x1E2EF},{0x1E4EC,0x1E4EF},{0x1E8D0,0x1E8D6},{0x1E944,0x1E94A},{0xE0100,0xE01EF},
};
static const int UC_M_N = 310;

static const uint32_t UC_N[][2] = {
...
{0x10B58,0x10B5F},{0x10B78,0x10B7F},{0x10BA9,0x10BAF},{0x10CFA,0x10CFF},{0x10D30,0x10D39},{0x10E60,0x10E7E},{0x10F1D,0x10F26},{0x10F51,0x10F54},
{0x10FC5,0x10FCB},{0x11052,0x1106F},{0x110F0,0x110F9},{0x11136,0x1113F},{0x111D0,0x111D9},{0x111E1,0x111F4},{0x112F0,0x112F9},{0x11450,0x11459},
{0x114D0,0x114D9},{0x11650,0x11659},{0x116C0,0x116C9},{0x11730,0x1173B},{0x118E0,0x118F2},{0x11950,0x11959},{0x11C50,0x11C6C},{0x11D50,0x11D59},
{0x11DA0,0x11DA9},{0x11F50,0x11F59},{0x11FC0,0x11FD4},{0x12400,0x1246E},{0x16A60,0x16A69},{0x16AC0,0x16AC9},{0x16B50,0x16B59},{0x16B5B,0x16B61},
{0x16E80,0x16E96},{0x1D2C0,0x1D2D3},{0x1D2E0,0x1D2F3},{0x1D360,0x1D378},{0x1D7CE,0x1D7FF},{0x1E140,0x1E149},{0x1E2F0,0x1E2F9},{0x1E4F0,0x1E4F9},
{0x1E8C7,0x1E8CF},{0x1E950,0x1E959},{0x1EC71,0x1ECAB},{0x1ECAD,0x1ECAF},{0x1ECB1,0x1ECB4},{0x1ED01,0x1ED2D},{0x1ED2F,0x1ED3D},{0x1F100,0x1F10C},
{0x1FBF0,0x1FBF9},
};
static const int UC_N_N = 137;

static const uint32_t UC_P[][2] = {
...
{0x1056F,0x1056F},{0x10857,0x10857},{0x1091F,0x1091F},{0x1093F,0x1093F},{0x10A50,0x10A58},{0x10A7F,0x10A7F},{0x10AF0,0x10AF6},{0x10B39,0x10B3F},
{0x10B99,0x10B9C},{0x10EAD,0x10EAD},{0x10F55,0x10F59},{0x10F86,0x10F89},{0x11047,0x1104D},{0x110BB,0x110BC},{0x110BE,0x110C1},{0x11140,0x11143},
{0x11174,0x11175},{0x111C5,0x111C8},{0x111CD,0x111CD},{0x111DB,0x111DB},{0x111DD,0x111DF},{0x11238,0x1123D},{0x112A9,0x112A9},{0x1144B,0x1144F},
...
{0x1183B,0x1183B},{0x11944,0x11946},{0x119E2,0x119E2},{0x11A3F,0x11A46},{0x11A9A,0x11A9C},{0x11A9E,0x11AA2},{0x11B00,0x11B09},{0x11C41,0x11C45},
{0x11C70,0x11C71},{0x11EF7,0x11EF8},{0x11F43,0x11F4F},{0x11FFF,0x11FFF},{0x12470,0x12474},{0x12FF1,0x12FF2},{0x16A6E,0x16A6F},{0x16AF5,0x16AF5},
{0x16B37,0x16B3B},{0x16B44,0x16B44},{0x16E97,0x16E9A},{0x16FE2,0x16FE2},{0x1BC9F,0x1BC9F},{0x1DA87,0x1DA8B},{0x1E95E,0x1E95F},
};
static const int UC_P_N = 191;

static const uint32_t UC_S[][2] = {
...
{0x10179,0x10189},{0x1018C,0x1018E},{0x10190,0x1019C},{0x101A0,0x101A0},{0x101D0,0x101FC},{0x10877,0x10878},{0x10AC8,0x10AC8},{0x1173F,0x1173F},
{0x11FD5,0x11FF1},{0x16B3C,0x16B3F},{0x16B45,0x16B45},{0x1BC9C,0x1BC9C},{0x1CF50,0x1CFC3},{0x1D000,0x1D0F5},{0x1D100,0x1D126},{0x1D129,0x1D164},
...
{0x1F810,0x1F847},{0x1F850,0x1F859},{0x1F860,0x1F887},{0x1F890,0x1F8AD},{0x1F8B0,0x1F8B1},{0x1F900,0x1FA53},{0x1FA60,0x1FA6D},{0x1FA70,0x1FA7C},
{0x1FA80,0x1FA88},{0x1FA90,0x1FABD},{0x1FABF,0x1FAC5},{0x1FACE,0x1FADB},{0x1FAE0,0x1FAE8},{0x1FAF0,0x1FAF8},{0x1FB00,0x1FB92},{0x1FB94,0x1FBCA},

};
static const int UC_S_N = 232;

static inline bool uc_in(const uint32_t (*t)[2], int n, uint32_t c) {
    int lo = 0, hi = n - 1;
